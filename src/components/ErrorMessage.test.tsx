...
describe('ErrorMessage', () => {
  describe('Basic Rendering', () => {
    ...
    test('renders with custom aria-label', () => {
      ...
      expect(screen.getByLabelText('Custom error description')).toBeInTheDocument();
    });
  ...
  describe('Suggestions Functionality', () => {
    ...
    test('renders clickable suggestion buttons when onSuggestionClick provided', () => {
      ...
      const suggestion = screen.getByRole('button', { name: 'Use suggestion: meter' });
  ...
  describe('Accessibility', () => {
    ...
    test('suggestion buttons have descriptive aria-labels', () => {
      ...
      expect(screen.getByLabelText('Use suggestion: meter')).toBeInTheDocument();
    });
    ...
    test('supports keyboard navigation for suggestions', async () => {
      ...
      const firstSuggestion = screen.getByRole('button', { name: 'Use suggestion: meter' });
      const secondSuggestion = screen.getByRole('button', { name: 'Use suggestion: foot' });
  ...
  describe('Error Content Handling', () => {
    test('handles long error messages', () => {
      const longMessage = 'This is a very long error message that should be handled gracefully by the component without breaking the layout or causing accessibility issues.';
  ...
  describe('Component Interaction', () => {
    test('handles multiple suggestion clicks correctly', async () => {
      ...
      await userEvent.click(screen.getByRole('button', { name: 'Use suggestion: meter' }));
      await userEvent.click(screen.getByRole('button', { name: 'Use suggestion: foot' }));
